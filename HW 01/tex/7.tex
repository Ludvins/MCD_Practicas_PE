...
\end{aligned}
  ...
  \]
\end{itemize}
We conclude by plotting the first three trajectories, all of which depict a standard Brownian motion; and also the distribution of the final values. The results can be consulted in the attached notebook.\\
